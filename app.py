...
if uploaded_file is not None:
    ...
    psnr_value = tf.image.psnr(
        input_array, predicted_array, max_val=1.0
    ).numpy()
    ...
    st.info(
        "This PSNR score shows how much detail and clarity the model added "
        "compared to a standard resize. Higher is better!"
    )
